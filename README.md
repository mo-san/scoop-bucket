...
|--|--|--|--|
| alt-ime-ahk | alt-ime-ahk | AutoHotKey script to turn off/on Japanese IME by hitting left/right Alt key alone. // 左右 Alt キーの空打ちで IME を OFF/ON する AutoHotKey スクリプト | https://github.com/karakaram/alt-ime-ahk |
